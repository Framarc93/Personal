...
toolbox.register('evaluate', evaluate, toolbox=toolbox, sourceData=data,
                 minTrades=minTrades, log=False)
...
algorithms.eaMuPlusLambda(pop, toolbox, mu=individuals, lambda_=individuals,
