...
def main(cxpb, mutpb):
    ...
    pop = toolbox.map(partial(funs.lst, evaluate_lst=evaluate_lst, Cd_new=Cd_new, delta_eval=delta_eval, change_time=change_time, x_ini=x_ini_real), best_pop)  # optimization on pop
