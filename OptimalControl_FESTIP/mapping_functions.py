...
def v_toNew(value):
    return to_new_int(value, 1.0, 1e4, 0.0, 1.0)


def v_toOrig(value):
    return to_orig_int(value, 1.0, 1e4, 0.0, 1.0)
...
def gamma_toNew(value):
    return to_new_int(value, np.deg2rad(-89.0), np.deg2rad(89.0), 0.0, 1.0)


def gamma_toOrig(value):
    return to_orig_int(value, np.deg2rad(-89.0), np.deg2rad(89.0), 0.0, 1.0)
...
def h_toNew(value):
    return to_new_int(value, 1.0, 2e5, 0.0, 1.0)


def h_toOrig(value):
    return to_orig_int(value, 1.0, 2e5, 0.0, 1.0)
...
def mu_toNew(value):
    return to_new_int(value, np.deg2rad(-80.0), np.deg2rad(80.0), 0.0, 1.0)


def mu_toOrig(value):
    return to_orig_int(value, np.deg2rad(-80.0), np.deg2rad(80.0), 0.0, 1.0)


def t_toNew(value):
    return to_new_int(value, 0.0, 600.0, 0.0, 1.0)


def t_toOrig(value):
    return to_orig_int(value, 0.0, 600.0, 0.0, 1.0)
