...
def inequalityAll(states, controls, varnum):
    ...
    iC = np.hstack((((obj.MaxAx - ax)/(obj.MaxAx*1e3), (obj.MaxAz - az)/(obj.MaxAz*1e3), (obj.MaxQ - q)/(obj.MaxQ*1e3),
                      (obj.k - MomTotA)/(obj.k*1e7), (mf - obj.m10)/unit_m,)))  # when with bounds
...
sparseJac = load_npz("/home/francesco/git_workspace/FESTIP_Work/MultipleShooting_Algorithm/sparse_festip_5leg9Cont.npz")#
...
#save_npz("/home/francesco/git_workspace/FESTIP_Work/MultipleShooting_Algorithm/sparse_festip_5leg9Cont.npz", sparse)