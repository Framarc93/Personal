...
Vlb = Xlb*Nleg*Nstates + Ulb * Ncontrols * (Nleg * NContPoints - Nbar + 2) + Tlb*Nleg
Vub = Xub*Nleg*Nstates + Uub * Ncontrols * (Nleg * NContPoints - Nbar + 2) + Tub*Nleg
bnds = Bounds(Vlb, Vub)
...
#sparseJac = load_npz("/home/francesco/git_workspace/FESTIP_Work/MultipleShooting_Algorithm/sparse_festip_5leg20contMu.npz")
...
save_npz("/home/francesco/git_workspace/FESTIP_Work/MultipleShooting_Algorithm/sparse_festip_5leg20contMu.npz", sparse)
plot(X0)