...
for i=1:prob.Nleg-1
    if i == 0
        eq_cond = [eq_cond, var(prob.varStates+i*prob.Ncontrols*prob.NContPointsLeg1-(prob.Ncontrols-1):prob.varStates+i*prob.Ncontrols*prob.NContPointsLeg1) ...
         - var(prob.varStates+i*prob.Ncontrols*prob.NContPointsLeg1+1:prob.varStates+i*prob.Ncontrols*prob.NContPointsLeg1+prob.Ncontrols)./divc];
    else
        eq_cond = [eq_cond, var(prob.varStates+prob.NContPointsLeg1*prob.Ncontrols+(i-1)*prob.Ncontrols*prob.NContPoints-(prob.Ncontrols-1):prob.varStates+prob.NContPointsLeg1*prob.Ncontrols+(i-1)*prob.Ncontrols*prob.NContPoints) ...
         - var(prob.varStates+prob.NContPointsLeg1*prob.Ncontrols+(i-1)*prob.Ncontrols*prob.NContPoints+1:prob.varStates+prob.NContPointsLeg1*prob.Ncontrols+(i-1)*prob.Ncontrols*prob.NContPoints+prob.Ncontrols)./divc];
    end
