...
for i=1:prob.Nleg
    ...
    controls = extract_controls(var(prob.varStates+1+(prob.Ncontrols*prob.NContPoints-prob.Ncontrols)*(i-1):prob.varStates+i*prob.Ncontrols*prob.NContPoints-prob.Ncontrols*(i-1)), prob.NContPoints, prob.Ncontrols);
    ...
    timestart = timeend;
    alfaCP(i,:)=controlsCp(1,:);
    deltaCP(i,:) = controlsCp(2,:);
    deltafCP(i,:) = controlsCp(3,:);
    tauCP(i,:) = controlsCp(4,:);
    muCP(i,:) = controlsCp(5,:);
