...
LbS = [0.5,  deg2rad(110), deg2rad(80),    deg2rad(-53), deg2rad(4.8), 0.5,  obj.M0-10, ... 
       ...
       4000, deg2rad(100), deg2rad(-10), deg2rad(-60), deg2rad(2.0),5e4,  1e5];

UbS = [5.0,  deg2rad(120), deg2rad(89.99), deg2rad(-51), deg2rad(5.8), 10.0, obj.M0+10, ... 
       5000, deg2rad(200), deg2rad(60), deg2rad(-45), deg2rad(8.0), 5e4,  4e5, ...
       1e4,  deg2rad(200), deg2rad(40), deg2rad(-45), deg2rad(15.0),1e5, 2e5];

LbC = [deg2rad(-0.5), 0.8, deg2rad(-0.5), -0.1, deg2rad(-0.1), ...
        deg2rad(-1.0), 0.8, deg2rad(-1.0), -0.2, deg2rad(-10), ...
        deg2rad(-2.0), 0.7, deg2rad(-5.0), -0.3, deg2rad(-10), ...
        deg2rad(-2.0), 0.5, deg2rad(-10.0), -0.4, deg2rad(-10), ...
        deg2rad(-2.0), 0.4, deg2rad(-20.0), -0.5, deg2rad(-10), ...
        deg2rad(-2.0), 0.3, deg2rad(-20.0), -0.7, deg2rad(-10), ...
        deg2rad(-2.0), 0.3, deg2rad(-20.0), -1.0, deg2rad(-10), ...
        deg2rad(-2.0), 0.25, deg2rad(-20.0), -1.0, deg2rad(-10), ...
        deg2rad(-2.0), 0.2, deg2rad(-20.0), -1.0, deg2rad(-10), ...
        deg2rad(-2.0), 0.1, deg2rad(-20.0), -1.0, deg2rad(-10), ...
        deg2rad(-2.0), 0.001, deg2rad(-20.0), -1.0, deg2rad(-10), ...
        deg2rad(-2.0), 0.001, deg2rad(-20.0), -1.0, deg2rad(-10), ...
        deg2rad(-2.0), 0.001, deg2rad(-20.0), -1.0, deg2rad(-5.0), ...
        deg2rad(-2.0), 0.001, deg2rad(-20.0), -1.0, deg2rad(-1), ...
        deg2rad(-2.0), 0.001, deg2rad(-20.0), -1.0, deg2rad(-0.1)];

UbC = [ deg2rad(0.5),  1.0, deg2rad(0.5), 0.1, deg2rad(0.1), ...
        deg2rad(1.0),  1.0, deg2rad(1.0), 0.1, deg2rad(10), ...
        deg2rad(10.0), 1.0, deg2rad(5.0), 0.2, deg2rad(10), ...
        deg2rad(10.0), 1.0, deg2rad(10.0), 0.3, deg2rad(10), ...
        deg2rad(10.0), 1.0, deg2rad(30.0), 0.4, deg2rad(10), ...
        deg2rad(10.0), 1.0, deg2rad(30.0), 0.5, deg2rad(10), ...
        deg2rad(10.0), 1.0, deg2rad(30.0), 0.6, deg2rad(10), ...
        deg2rad(10.0), 1.0, deg2rad(30.0), 1.0, deg2rad(10), ...
        deg2rad(10.0), 1.0, deg2rad(30.0), 1.0, deg2rad(10), ...
        deg2rad(10.0), 1.0, deg2rad(30.0), 1.0, deg2rad(10), ...
        deg2rad(10.0), 1.0, deg2rad(30.0), 1.0, deg2rad(10.0), ...
        deg2rad(10.0), 1.0, deg2rad(30.0), 1.0, deg2rad(10.0), ...
        deg2rad(10.0), 1.0, deg2rad(30.0), 1.0, deg2rad(5.0), ...
        deg2rad(10.0), 1.0, deg2rad(30.0), 1.0, deg2rad(1.0), ...
        deg2rad(5.0), 1.0, deg2rad(30.0), 1.0, deg2rad(0.1)];
