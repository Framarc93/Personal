function impulse1 = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   IMPULSE1 = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   IMPULSE1 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   impulse1 = importfile1('impulse.dat', 1, 17);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/06/06 14:34:33
...
impulse1 = table(dataArray{1:end-1}, 'VariableNames', {'E00','E1'});
