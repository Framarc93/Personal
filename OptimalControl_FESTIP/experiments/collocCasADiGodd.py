...
Xk = ca.MX.sym('X0', 5)
w.append(Xk)
lbw.append([0, 1, 1, 1, 1])
ubw.append([0, 1, 1, 1, 1])
w0.append([0, 1, 1, 1, 1])
x_plot.append(Xk)
...
for k in range(N):
    ...
    w.append(Uk)
    lbw.append([0.0, 0.0])
    ubw.append([obj.Tmax, obj.Tmax])
    w0.append([obj.Tmax/2, obj.Tmax/2])
    u_plot.append(Uk)

    # State at collocation points
    Xc = []
    for j in range(d):
        Xkj = ca.MX.sym('X_'+str(k)+'_'+str(j), 5)
        Xc.append(Xkj)
        w.append(Xkj)
        lbw.append([obj.Re, 0.0, 0.0, 0.0, (obj.M0 - obj.Mp))
