...
def inequality(prob, obj):
    ...
    result.upper_bound(malfa, np.repeat(np.tan(1.22), n[0]-1), unit=1) # bound on alfa slope
    # result.upper_bound(malfa[obj.n65:], np.repeat(np.tan(0.31), obj.n35 - 1), unit=1) # bound on slope of last alfa points
    result.upper_bound(mdeltaf, np.repeat(np.tan(1.22), n[0]-1), unit=1) # bound on deltaf slope
    ...
    result.upper_bound(mmu, np.repeat(np.tan(1.22), n[0]-1), unit=1)  # bound on mu slope
...
if __name__ == '__main__':
    ...
    np.save(
        "/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/lambda".format(
    ...
    np.save(
        "/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/deltaf".format(
    ...
    np.save(
        "/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/timeTot".format(
            os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), tres)
    np.save(
        "/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/timeCol".format(
