...
class Spaceplane():
    ...
    def __init__(self):
        ...
        self.gamma_lb = np.hstack((np.repeat(to_new_int(np.deg2rad(80), np.deg2rad(-50), np.deg2rad(89.9), 0.0, 1.0), self.n20),
                              np.repeat(to_new_int(np.deg2rad(-50), np.deg2rad(-50), np.deg2rad(89.9), 0.0, 1.0),self.n80)))
...
def equality(prob, obj):
    ...
    result.equal(to_new_int(gamma[0], np.deg2rad(-50), np.deg2rad(89.9), 0.0, 1.0),
                 to_new_int(obj.gammastart, np.deg2rad(-50), np.deg2rad(89.9), 0.0, 1.0), unit=1)
    ...
    result.equal(to_new_int(gamma[-1], np.deg2rad(-50), np.deg2rad(89.9), 0.0, 1.0),
                 to_new_int(0.0, np.deg2rad(-50), np.deg2rad(89.9), 0.0, 1.0), unit=1)
...
def inequality(prob, obj):
    ...
    result.lower_bound(to_new_int(gamma, np.deg2rad(-50), np.deg2rad(89.9), 0.0, 1.0),  #obj.gamma_lb, unit=1)
                       to_new_int(np.deg2rad(-50), np.deg2rad(-50), np.deg2rad(89.9), 0.0, 1.0),
    ...
    result.upper_bound(to_new_int(gamma, np.deg2rad(-50), np.deg2rad(89.9), 0.0, 1.0),
                       to_new_int(np.deg2rad(89.9), np.deg2rad(-50), np.deg2rad(89.9), 0.0, 1.0),
    ...
    #result.upper_bound(mchi[:obj.n20], np.repeat(np.tan(0.44), obj.n20), unit=1) # bound on slope of first chi points
    #result.upper_bound(mgamma[:obj.n20], np.repeat(np.tan(0.44), obj.n20), unit=1) # bound on slope of first gamma points
    result.upper_bound(malfa, np.repeat(np.tan(1.31), n[0]-1), unit=1) # bound on alfa slope
    # result.upper_bound(malfa[obj.n65:], np.repeat(np.tan(0.31), obj.n35 - 1), unit=1) # bound on slope of last alfa points
    result.upper_bound(mdeltaf, np.repeat(np.tan(1.31), n[0]-1), unit=1) # bound on deltaf slope
    ...
    result.upper_bound(mmu, np.repeat(np.tan(1.31), n[0]-1), unit=1)  # bound on mu slope
    #result.upper_bound(mmu[obj.n35:obj.n65], np.repeat(np.tan(1.31), obj.n65 - obj.n35), unit=1)
...
if __name__ == '__main__':
    ...
    maxiter = 40
    ftol = 1e-8
    os.makedirs("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr))
    savefig_file = "/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/Res_".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr)
    # -------------
    ...
    res = open(
        "/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/resColloc_{}_{}.txt".format(
            os.path.basename(__file__), n[0], maxiter, max_iteration, timestr, os.path.basename(__file__), timestr),
        "w")
    ...
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/v".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), vres)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/chi".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), chires)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/gamma".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), gammares)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/teta".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), tetares)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/lambda".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), lamres)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/h".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), hres)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/m".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), mres)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/alfa".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), alfa)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/delta".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), delta)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/deltaf".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), deltaf)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/tau".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), tau)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/mu".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), mu)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/timeTot".format(
        os.path.basename(__file__), n[0], maxiter, max_iteration, timestr), tres)
    np.save("/home/francesco/git_workspace/FESTIP_Work/Collocation_Algorithm/Results/Res{}_p{}_it{}x{}_{}/timeCol".format(
